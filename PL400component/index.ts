...
export class PL400component implements ComponentFramework.StandardControl<
  IInputs,
  IOutputs
> {
  ...
  public init(
    ...
    this.myIsUpperCaseOnly = context.parameters.isUpperCaseOnly.raw;
